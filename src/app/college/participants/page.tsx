...
export default function CollegeParticipantsPage() {
  ...
  const fetchParticipants = async () => {
    setLoading(true);
    try {
      const res = await axios.get("/api/college/participants");
      if (res.data.success) {
  ...
  return (
    <div className="poppins space-y-6 pb-12">
      <Title
        title="College Fest Participants"
        subtitle="Manage and export lists of all teams and student participants registered in your college programs."
      />
