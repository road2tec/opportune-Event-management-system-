...
export default function SmartSchedulingAIPage() {
  ...
  // Hardcoded existing college calendar fests for conflict checks
  ...
  const handleAnalyze = () => {
    ...
    setTimeout(() => {
      ...
      // 1. Check direct overlap (Same Venue + Same Date + Timing Conflict within a 3-hour block)
      ...
      // 3. Check Low Attendance timing (Early mornings before 8 AM or nights after 7 PM)
